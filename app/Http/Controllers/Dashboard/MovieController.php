...
class MovieController extends Controller
{
    public function list():Response {
        ...
        return Inertia::render('dashboard/movie/List',['videos'=>$videos,'categories'=>$categories,'list'=>$list]);
    }

    public function create(Request $request):RedirectResponse {
       $validated = $request->validate([
        'name' => 'required|string|max:100|unique:movies,name',
        'poster' => 'nullable|image|mimes:jpeg,png,jpg|max:2048', // Added max size
        'meta_banner' => 'nullable|image|mimes:jpeg,png,jpg|max:2048',
